...
CKEDITOR.dialog.add("symbol", function (j) {
    ...
    return{title: "Selecionar Caractere Especial", buttons: x, charColumns: 16, onShow: function () {
            ...
            {type: "vbox", align: "top", width: "100%", children: [
                ...
                {type: "hbox", align: "top", width: "100%",
                    children: [
                        ...
                        {type: "html", id: "unicodePreview", className: "cke_dark_background", style: "border:1px solid #eeeeee;font-size:14px;height:20px;width:192px;padding-top:25px;font-family:'Microsoft Sans Serif',Arial,'Arial Unicode',Helvetica,Verdana;text-align:center;", html: "<div>&nbsp;</div>"},
